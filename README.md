...
- **IoT & Hardware:** Arduino, ESP8266, Sensors (DHT11, RFID, MQ-135), Relay, Buzzer  
- **Programming:** C, Python (MicroPython), PHP (Laravel), HTML, CSS, JS  
- **Networking:** Cisco Packet Tracer, MQTT, Local Server Setup  
- **Database:** MySQL  
- **Design & Tools:** AutoCAD (sketsa), Figma (wireframe), VS Code, Git  

---

### 🧠 Current Projects

- 🚗 **Automatic Toll Gate System** – RFID-based IoT prototype with ESP8266 and MQTT  
- 🏠 **Smart Home Automation & Security** – IoT-based home system project  
- 💻 **Local Dashboard for IoT Monitoring** – Displays temperature, humidity, and gas levels in real time  
